...
local lines = {
  ...
  " ─────────────────────────────────────────────────────────── ",
  "  AI COMPLETION  (off by default — opt in per project)        ",
  "   <leader>la       enable Claude AI completion, project-wide ",
  "                    (writes/trusts/sources .nvim.lua)         ",
  "   <leader>lc       enable GitHub Copilot, project-wide        ",
  "                    (writes/trusts/sources .nvim.lua)          ",
  "   :Copilot auth    sign in to Copilot (one-time; prints a     ",
  "                    URL + code — open it, enter the code)      ",
  "   :Copilot status  confirm Copilot is signed in               ",
  "   <A-]> / <A-[>    request / cycle suggestion (Claude: works  ",
  "                    even without opting in; Copilot needs      ",
  "                    <leader>lc + :Copilot auth first)           ",
  "   <A-a>            accept full suggestion                    ",
  "   <A-l>            accept one line of suggestion              ",
  "   <A-e>            dismiss suggestion                        ",
  "   <Right>          accept suggestion (else: normal cursor     ",
  "                    move right, whichever engine is active)    ",
  "   <S-Right>        request/cycle suggestion (both engines)    ",
  "   note: Claude engine isn't used day-to-day — it needs paid  ",
  "   Anthropic API credits (not covered by a Pro plan). Copilot ",
  "   is free via the Student Dev Pack, so that's the one in use.",
  ...
  "     AI completion has no per-language list — once opted in,  ",
  "     it applies to every filetype (Zig included) already.     ",
  " ─────────────────────────────────────────────────────────── ",
  "  TERMINAL / TABS                                            ",
